<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreviousUserRecord.aspx.cs" Inherits="Reports_PreviousUserRecord" %>
...
<body>
   ...
   <div >
     ...
     <tr><td>&nbsp;</td></tr>
            ...
            <td width="20%" align="left" valign="top"><font style="color:Red;">*</font> Asset &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:DropDownList ID="DdlistAsset" runat="server" Width="130px">
                
                </asp:DropDownList>
                </td>
                <td width="20%" align="left" valign="top"><font style="color:Red;">*</font>User&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:DropDownList ID="DdlistUser" runat="server" Width="130px">
                
                </asp:DropDownList>
                </td>
                
                 <td width="20%" align="left" valign="top"><font style="color:Red;">*</font>
                From<asp:TextBox ID="txtFromDate" runat="server"></asp:TextBox>
                 ...
                 <td width="20%" align="left"><font style="color:Red;">*</font>
                    To &nbsp;&nbsp;
       ...
       <tr><td>&nbsp;</td></tr>
            ...
            <tr>
                <td align="center" colspan="5">
                    <rsweb:ReportViewer ID="ReportViewerUserRecord" runat="server" BackColor="LightSteelBlue" ShowParameterPrompts="false"
