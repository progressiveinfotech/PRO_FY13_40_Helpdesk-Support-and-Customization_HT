...
<td width="50%"><asp:Label ID="lblWorkStations" runat="server" Font-Bold="true" Text="0"></asp:Label></td>

</tr>
<tr bgcolor=white>
<td width="50%"><asp:Label ID="Label4" runat="server" Text="Network Devices"  Font-Bold="false"   Font-Size="11px"></asp:Label></td>
<td width="50%"><asp:Label ID="lblNetworkdevices" runat="server" Font-Bold="true" Text="0"></asp:Label></td>
...
<td width="50%"><asp:Label ID="lblWindowsXp" runat="server" Font-Bold="true" Text="0"></asp:Label></td>
...
<td width="50%"><asp:Label ID="lblWindows2003" runat="server" Font-Bold="true" Text="0"></asp:Label></td>
